...
<!--[if lte IE 8]> <div style="color:#fff;background:#f00;padding:20px;text-align:center;"> ${page.SITE.name} no longer actively supports this version of Internet Explorer. We suggest that you <a href="https://windows.microsoft.com/en-us/internet-explorer/download-ie" style="color:#fff;text-decoration:underline;">upgrade to a newer version</a> or <a href="https://browsehappy.com/" style="color:#fff;text-decoration:underline;">try a different browser</a>. </div> <![endif]-->
...
<div bis_skin_checked='1' class='off-canvas-left__current-site -color-${page.SITE.name}'>
<span class='off-canvas-left__site-title'>
                        Web Themes & Templates
                    </span>
<a class='off-canvas-left__current-site-toggle -white-arrow -color-${page.SITE.name}' data-dropdown-target='.off-canvas-left__sites' data-view='dropdown' href='${page.canonical}'></a>
</div>
...
<a class='header-site-titles__link t-link elements-nav__main-link' href='https://elements.envato.com/?utm_campaign=elements_mkt-switcher_31JUL2024&utm_content=tf_item_8988002&utm_medium=referral&utm_source=${page.SITE.name}.net' target='_blank'>
<span>
                                                    Unlimited Downloads
                                                </span>
</a>
<a class='elements-nav__dropdown-container unique-selling-points__variant' data-analytics-click-payload='{"eventName":"select_promotion","contextDetail":"site switcher","ecommerce":{"promotionId":"elements_mkt-switcher_31JUL2024","promotionName":"elements_mkt-switcher_31JUL2024","promotionType":"elements referral"}}' data-analytics-view-payload='{"eventName":"view_promotion","contextDetail":"site switcher","ecommerce":{"promotionId":"elements_mkt-switcher_31JUL2024","promotionName":"elements_mkt-switcher_31JUL2024","promotionType":"elements referral"}}' href='https://elements.envato.com/?utm_campaign=elements_mkt-switcher_31JUL2024&utm_content=tf_item_8988002&utm_medium=referral&utm_source=${page.SITE.name}.net' target='_blank'>
